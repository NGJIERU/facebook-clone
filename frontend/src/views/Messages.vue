<template>
  <div class="min-h-screen bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-6 max-w-5xl">
      <div class="bg-white rounded-lg shadow overflow-hidden" style="height: calc(100vh - 140px);">
        <div class="flex h-full">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex justify-between items-center">
                      <span class="font-semibold text-gray-800">{{ conv.partnerName }}</span>
          ...
          <div class="flex-1 flex flex-col">
            <div v-if="!selectedPartnerId" class="flex-1 flex items-center justify-center text-gray-400">
            ...
            <template v-else>
              ...
              <div class="p-4 border-b flex items-center gap-3">
                ...
                <span class="font-semibold">{{ selectedPartnerName }}</span>
              </div>
    ...
    <div v-if="showNewMessageModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" @click="showNewMessageModal = false">
      <div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" @click.stop>
        ...
        <p class="text-gray-600 mb-4">Select a friend to message:</p>
