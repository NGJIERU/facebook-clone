...
<template>
  <div class="relative" ref="dropdownRef">
    ...
    <button 
      ...
      class="p-2 text-gray-600 hover:text-blue-600 transition relative focus:outline-none"
    >
    ...
    >
        <div class="px-4 py-2 border-b border-gray-100 font-semibold text-gray-700 flex justify-between items-center">
            ...
            <span class="text-xs text-gray-400 font-normal">History</span>
        </div>

        <div class="max-h-96 overflow-y-auto">
            <div v-if="notificationStore.history.length === 0" class="px-4 py-6 text-center text-gray-500 text-sm">
            ...
            <div 
                ...
                class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition flex gap-3 items-start"
