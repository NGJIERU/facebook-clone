    ...
    <div class="flex gap-4">
      ...
      <div class="flex-grow">
        <textarea 
            ...
            class="w-full bg-gray-100 dark:bg-gray-700 dark:text-gray-100 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none h-24 mb-2 dark:placeholder-gray-400"
        ></textarea>
        ...
        <div class="flex justify-between items-center mt-2 border-t pt-2 border-gray-100 dark:border-gray-600">
            <div>
                <input 
                    type="file" 
                    ref="fileInput" 
                ...
                <button 
                    ...
                    class="flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-2 rounded-lg transition"
                >
